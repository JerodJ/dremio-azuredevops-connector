...
@SourceType(value = "AzureDevOpsARP", label = "AzureDevOps",uiConfig = "azuredevops-layout.json")
public class AzureDevOpsConf extends AbstractArpConf<AzureDevOpsConf> {
  private static final String ARP_FILENAME = "arp/implementation/azuredevops-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.azuredevops.AzureDevOpsDriver";
